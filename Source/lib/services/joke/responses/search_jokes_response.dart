class SearchJokesResponse {
  bool? error;
  int? amount;
  List<Jokes>? jokes;

  SearchJokesResponse({this.error, this.amount, this.jokes});

  SearchJokesResponse.fromJson(Map<String, dynamic> json) {
    error = json['error'];
    amount = json['amount'];
    if (json['jokes'] != null) {
      jokes = <Jokes>[];
...
class Jokes {
  ...
  Jokes({this.category, this.type, this.setup, this.delivery, this.flags, this.id, this.safe, this.lang, this.joke});
