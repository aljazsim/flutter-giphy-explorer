class SearchGiphsResponse {
  List<Data>? data;
  Pagination? pagination;
  Meta? meta;

  SearchGiphsResponse({this.data, this.pagination, this.meta});

  SearchGiphsResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    analytics = json['analytics'] != null ? new Analytics.fromJson(json['analytics']) : null;
  }
...
class Images {
  ...
  Images.fromJson(Map<String, dynamic> json) {
    ...
    downsized = json['downsized'] != null ? new Downsized.fromJson(json['downsized']) : null;
    downsizedLarge = json['downsized_large'] != null ? new Downsized.fromJson(json['downsized_large']) : null;
    downsizedMedium = json['downsized_medium'] != null ? new Downsized.fromJson(json['downsized_medium']) : null;
    downsizedSmall = json['downsized_small'] != null ? new DownsizedSmall.fromJson(json['downsized_small']) : null;
    downsizedStill = json['downsized_still'] != null ? new Downsized.fromJson(json['downsized_still']) : null;
    fixedHeight = json['fixed_height'] != null ? new FixedHeight.fromJson(json['fixed_height']) : null;
    fixedHeightDownsampled = json['fixed_height_downsampled'] != null ? new FixedHeightDownsampled.fromJson(json['fixed_height_downsampled']) : null;
    fixedHeightSmall = json['fixed_height_small'] != null ? new FixedHeight.fromJson(json['fixed_height_small']) : null;
    fixedHeightSmallStill = json['fixed_height_small_still'] != null ? new Downsized.fromJson(json['fixed_height_small_still']) : null;
    fixedHeightStill = json['fixed_height_still'] != null ? new Downsized.fromJson(json['fixed_height_still']) : null;
    fixedWidth = json['fixed_width'] != null ? new FixedHeight.fromJson(json['fixed_width']) : null;
    fixedWidthDownsampled = json['fixed_width_downsampled'] != null ? new FixedHeightDownsampled.fromJson(json['fixed_width_downsampled']) : null;
    fixedWidthSmall = json['fixed_width_small'] != null ? new FixedHeight.fromJson(json['fixed_width_small']) : null;
    fixedWidthSmallStill = json['fixed_width_small_still'] != null ? new Downsized.fromJson(json['fixed_width_small_still']) : null;
    fixedWidthStill = json['fixed_width_still'] != null ? new Downsized.fromJson(json['fixed_width_still']) : null;
    looping = json['looping'] != null ? new Looping.fromJson(json['looping']) : null;
    originalStill = json['original_still'] != null ? new Downsized.fromJson(json['original_still']) : null;
    originalMp4 = json['original_mp4'] != null ? new DownsizedSmall.fromJson(json['original_mp4']) : null;
    preview = json['preview'] != null ? new DownsizedSmall.fromJson(json['preview']) : null;
    previewGif = json['preview_gif'] != null ? new Downsized.fromJson(json['preview_gif']) : null;
    previewWebp = json['preview_webp'] != null ? new Downsized.fromJson(json['preview_webp']) : null;
    hd = json['hd'] != null ? new DownsizedSmall.fromJson(json['hd']) : null;
    d480wStill = json['480w_still'] != null ? new Downsized.fromJson(json['480w_still']) : null;
  }
...
class Analytics {
  ...
  Analytics.fromJson(Map<String, dynamic> json) {
    onload = json['onload'] != null ? new Onload.fromJson(json['onload']) : null;
    onclick = json['onclick'] != null ? new Onload.fromJson(json['onclick']) : null;
    onsent = json['onsent'] != null ? new Onload.fromJson(json['onsent']) : null;
  }
